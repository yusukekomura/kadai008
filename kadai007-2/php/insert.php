...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO gs_test_table(id, name, email, year, company, birthday, sex, job ,experience,
indate )VALUES(NULL, :name, :email, :year, :company, :birthday, :sex, :job, :experience, sysdate())");
